...
function AddProject(props) {
  ...
  const [textBoxEnabled, setTextBoxEnabled] = useState({});
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
          <Row>
            ...
            <Col>
              <Form.Group
                ...
                controlId="customValue.CICs"
              >
                <Form.Label>Estimated of CIC's *</Form.Label>
                <Form.Control
                  type="text"
                  placeholder="Enter Estimated of CIC's"
                  {...register("estimatedCICs", { required: true })}
                />
                {errors.customValue && (
            ...
            <Col>
              <Form.Group controlId="scale.custom2" className={`mb-3`}>
                <Form.Label>Custom Value #2</Form.Label>

                <Form.Control
                  type="text"
                  placeholder="Enter Custom Value #2"
                  {...register("customValue2", { required: false })}
                />
                ...
                {/* <MultiSelect
                  ...
                  optionLabel="name"
                  filter
                  placeholder="Select custom value2"
                  name="selectedCities"
                  className={
                ...
                {/* {selectedCities && !selectedCities.length && (
                  <span className="error-text">
                    Please select at least one custom
                  </span>
                )} */}
              </Form.Group>
            </Col>
          ...
          <Row>
            ...
            <Col>
              <Form.Group
                className="mb-3"
                controlId="customValue2.ControlInput1"
              >
          ...
          <Row>
            ...
            <Col>
              <Form.Group
                ...
                controlId="groupName.ControlInput1"
              >
                <Form.Label>Estimated # of POA’s *</Form.Label>
                <Form.Control
                  type="text"
                  min={0}
                  placeholder="Enter Estimated # of POA’s"
                  {...register("estimatedPOA", { required: true })}
                />
                {/* {errors.groupName && (
                  <span className="error-text">This field is required</span>
                )} */}
            ...
            <Col>
              <Form.Group className="mb-3" controlId="groupName.ControlInput1">
                ...
                <Form.Control
                  ...
                  {...register("customValue1", { required: false })}
                />
                {/* {errors.groupName && (
                  <span className="error-text">This field is required</span>
                )} */}
          ...
          <Row>
                ...
                <div className="design-scope">
                  {designScope.map((option, index) => (
                    <span key={index} style={{ display: "flex" }}>
                      ...
                      <Form.Control
                        type="text"
                        value={!textBoxEnabled[option.value] ?"": designScopeList[option.value]}
                        onChange={(e) => {
            ...
            <Col>
              <Form.Group controlId="projectType.SelectMultiple">
                ...
                <div>
                  <Form.Control value="Pranali" disabled></Form.Control>
                </div>
              </Form.Group>
            </Col>
          </Row>
